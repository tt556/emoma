...
class LoginController: UIViewController {
    ...
    lazy var loginRegisterButton: UIButton = {
        ...
        button.backgroundColor = UIColor.rgba(red: 80, green: 101, blue: 161, alpha: 1)
    ...
    let nameSeparatorView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor.rgba(red: 220, green: 220, blue: 220, alpha: 1)
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
    ...
    lazy var profileImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "acount_default.png")
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor.rgba(red: 163, green: 181, blue: 229, alpha: 1)
...
//        self.init(red: r/255, green: g/255, blue/255, alpha: 1)
//    }
//}
